# Works for any CPS data Aug 2005 to Dec 2006 
# or Jan 2007 to Dec 2008 
# or Jan 2010 to Apr 2012
# or Jan 2017 to Sep 2019
# Spreadsheet uses data from http://thedataweb.rm.census.gov/pub/cps/basic/200508-/apr06pub.zip
# and http://thedataweb.rm.census.gov/pub/cps/basic/200701-/apr08pub.zip
# and http://thedataweb.rm.census.gov/pub/cps/basic/201001-/apr10pub.zip
# and http://thedataweb.rm.census.gov/pub/cps/basic/201001-/apr12pub.zip
# and http://thedataweb.rm.census.gov/pub/cps/basic/201701-/apr18pub.zip
...
with open('apr18pub.dat') as f:
    rawdata = f.readlines()

compiled_data = {}

for row in rawdata:
    current_hhuid = row[0:15] + row[70:76]
...
groups = categories(max_num_adults=3, max_num_children=3)
total_adults = 0
total_infants = 0
