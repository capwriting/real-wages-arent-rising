# Works for any CPS data January 2003 to April 2004
# Spreadsheet uses data from http://thedataweb.rm.census.gov/pub/cps/basic/200301-/apr04pub.zip
...
with open('apr04pub.cps') as f:
    rawdata = f.readlines()

compiled_data = {}

for row in rawdata:
    # Characters 74-75 identify different housing units within the same household
    # Different units are presumed to have their own housing costs and so are treated as separate households
    # I realize this isn't a perfect solution, but affects only a small number of records
